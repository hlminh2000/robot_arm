...
pub const DigitalControlledServo = struct {
    _name: String,
    _servo: Servo,
    _controlPin: u8,
    _wasOn: bool,

    pub fn init(comptime name: String, controlPin: u8, servoPin: u4) DigitalControlledServo {
        var servo = Servo.init(servoPin);
    ...
    pub fn sync(self: *DigitalControlledServo) void {
